      ...
      <div className="max-w-4xl mx-auto px-8 py-20">
        ...
        <div className="flex items-center justify-between mb-20 max-w-xs mx-auto relative">
          ...
          <div className="flex flex-col items-center relative z-10">
            <div className="w-8 h-8 rounded-full bg-primary text-white flex items-center justify-center text-xs font-bold shadow-saas ring-4 ring-primary/10">1</div>
            <span className="text-[10px] font-black mt-2 text-text-primary uppercase tracking-wider">Upload</span>
          </div>
          <div className="flex flex-col items-center relative z-10">
        ...
        <div className="bg-white border border-border rounded-xl shadow-saas-lg overflow-hidden relative transition-all duration-300 hover:shadow-saas-lg hover:scale-[1.01]">
          <div className="p-10 md:p-20">
            <div className="text-center mb-10">
              <h2 className="text-2xl font-bold text-text-primary mb-2 tracking-tight uppercase">Import candidates</h2>
              <p className="text-text-secondary text-sm font-medium">Start your recruitment cycle by uploading a candidate sheet.</p>
            </div>
            
            <div 
              className={`border-2 border-dashed rounded-xl p-10 md:p-20 text-center transition-all cursor-pointer group/upload ${file ? 'border-primary bg-primary/5' : 'border-border hover:border-primary/50 hover:bg-surface'}`}
            ...
            >
              ...
              {file ? (
                <div className="flex flex-col items-center animate-in zoom-in-95 duration-200">
                  <div className="w-16 h-16 bg-primary/10 rounded-lg flex items-center justify-center text-primary mb-4 border border-primary/20">
                ...
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 bg-surface rounded-lg flex items-center justify-center text-text-secondary mb-4 border border-border transition-all group-hover/upload:scale-110 group-hover/upload:text-primary group-hover/upload:border-primary/30">
                    <Upload size={32} />
                  </div>
            ...
            <div className="mt-10 flex flex-col items-center">
              <button
                ...
                className={`w-full max-w-sm py-4 rounded-lg font-bold text-sm transition-all transform active:scale-[0.98] cursor-pointer ${!file || loading ? 'bg-surface text-text-secondary cursor-not-allowed border border-border' : 'bg-primary text-white hover:bg-primary/90 shadow-saas'}`}
              >
                {loading ? (
              ...
              <div className="mt-10 flex items-center gap-4 text-[10px] font-black text-text-secondary uppercase tracking-widest">
          ...
          {status.type === 'success' && (
            <div className="bg-primary/5 p-10 border-t border-border animate-in slide-in-from-bottom duration-500">
              <div className="flex items-center text-success font-bold text-lg mb-10">
                <CheckCircle2 size={24} className="mr-3" />
                {status.message}
              </div>
              
              <div className="bg-white border border-border rounded-xl overflow-hidden mb-10 shadow-saas">
              ...
              <button
                ...
                className="w-full bg-primary text-white py-4 rounded-lg font-bold text-sm hover:bg-primary/90 transition-all flex items-center justify-center group shadow-saas cursor-pointer"
              >
          ...
          {status.type === 'error' && (
            <div className="bg-red-50 p-8 border-t border-red-100 flex items-start text-error animate-in fade-in duration-300">
